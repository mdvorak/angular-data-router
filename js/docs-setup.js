NG_DOCS={
  "sections": {
    "build": "Angular Data Router Documentation"
  },
  "pages": [
    {
      "section": "build",
      ...
      "keywords": "_note build controllers describes existing locals module overview provided resolvables router view"
    },
    {
      "section": "build",
      "id": "locals.$data",
      ...
      "keywords": "$data $http $scope build controller data function js loaded locals module object parsed samplectrl scope service set"
    },
    {
      "section": "build",
    ...
    },
    {
      ...
      "keywords": "$datatype $scope build controller data function js loaded locals media module object samplectrl service type"
    },
    {
      "section": "build",
      "id": "locals.$dataUrl",
      ...
      "keywords": "$dataurl $http $scope api build controller data delete deleteself equals function header js locals location module note perform redirect remove resource response samplectrl service url"
    },
    {
      "section": "build",
      "id": "mdvorakDataApi",
      ...
      "keywords": "$dataapiprovider allows api build details mapping mdvorakdataapi module overview provider standalone two-way urls view"
    },
    {
      "section": "build",
      ...
      "keywords": "$dataapi $location absolute account angular api base behavior browser build change changed configuration configured context counterpart current currently default dependent empty equals error expected extension full hostname href html5 http includes including inside internally location logged mapapitoview maps mapviewtoapi mdvorakdataapi method methods_mapapitoview methods_mapviewtoapi methods_url mode modifies namespace normalized normalizes normalizeurl note null overridden path paths performed performs point prefix redirect relative requests resource returned returns server-relative service set sets string tag takes undefined url urls versa vice view viewed"
    },
    {
      "section": "build",
      ...
      "keywords": "$dataapi $dataapiprovider $datarouterprovider $location _note absolute account allows anchor api apiprefix attribute base behave behaves behavior browser build cases configuration configure configured configures context counterpart current default dependent empty equals expected full hostname href html5 http ignored includes including inside mapapitoview mapping maps mapviewtoapi mdvorakdataapi mdvorakdatarouter method methods_apiprefix methods_mapapitoview methods_mapviewtoapi methods_normalizeurl methods_prefix mode namespace normalized normalizes normalizeurl note null object overridden path paths prefix provider relative requests resource returned server-relative service shortcut starts string tag takes undefined url view weird"
    },
    {
      "section": "build",
      ...
      "keywords": "$datarouterprovider angular build configure data mdvorakdataapi mdvorakdatarouter module overview router"
    },
    {
      "section": "build",
    ...
    },
    {
      ...
      "keywords": "$datarouterloader $datarouterregistry abstraction allows application build completely content current data displayed doesn eagerly false fetched fetches finally flag forcereload format including indicating initialized loaded loading loads locals match mdvorakdatarouter media mediatype method mimetype normalized normalizemediatype normalizes parameter prefetch prefetchtemplate preparation prepares prepareview prepends promise provided registered reloaded removes resolvables resolves response returned returns routedataupdate service set subtype suffix template type unknown update url view views"
    },
    {
      "section": "build",
    ...
    },
    {
      ...
      "keywords": "$dataapiprovider $datarouterprovider $scope _blank _self ac angular api api-href api-type apihref apiprefix apitype application attribute avoid base behave behavior browser build case changes code config configured confusion controller data detail directive download downloaded error example expression external force full function hasbang href html html5mode ignored image inside js link links mapped maps mdvorakdataapi mdvorakdatarouter media mode module navigates navigation ng-controller nghref opens optional parent performed performs png points prefetched prefix recommend recommended redirect redirects reload replacement resolves resource sample samplectrl scenarios screen server set sets setting specification supported supports target template templateurl translates triggers type url users view window wrapper"
    },
    {
      "section": "build",
    ...
    },
    {
      ...
      "keywords": "ac active api-href apihref attr attribute behavior build complementary defines directive directives disable disabled empty empty-href emptyhref example hide href html ignored invalid link links logged mdvorakdatarouter nghref usage visible warning"
    },
    {
      "section": "build",
      ...
      "type": "directive",
      "moduleName": "mdvorakDataRouter",
      "keywords": "$location ac api api-href application behavior build calling conjuction directive entry-point entrypointhref generates link mdvorakdatarouter ng-href path produces root"
    }
  ],
  "apis": {
    "build": false
